...
-Use PivotTables and PivotCharts to generate bar plots stratified by sex,race or CT scan responses.
...
The below example plots were generated using PivotTables and PivotCharts with simulated lung cancer data, totaling 31 participants.

#### **1).Stacked column chart by sex:**
...
```{r, fig.margin=TRUE, fig.show='hold', fig.cap="Bar chart by sex", fig.align='center', out.width="120%", out.height="150%", echo=FALSE}
include_graphics("CT scan by sex.png")
```

#### **2).Stacked column chart by race:**
...
```{r, fig.margin=TRUE, fig.show='hold', fig.cap="Bar chart by race", fig.align='center', out.width="100%", out.height="150%", echo=FALSE}
include_graphics("CT scan by race.png")
```

#### **3). Bar chart for 10 Likert-scale questions:**  
The Likert-scale questionnaire contains 10 statements designed to assess participants' knowledge and attitudes toward lung cancers.  
The stacked bar plots visualizing responses to Likert scale questions, stratified by the answers to a CT scan question ("Yes," "No," "Don't know"). 
Generally, participants who answered "Yes" or "No" show a wider range of responses (with a balance of "Agree" and "Strongly Agree" answers), while those who answered "Don't know" tend to cluster around neutral or "Neither agree nor disagree.  
For questions related to sharing information with family and friends or discussing lung cancer with healthcare providers (Knowledge_question6 and Knowledge_question7), there is a positive responses, particularly in the "Yes" group, indicating more comfort and willingness in those who likely had a CT scan.

```{r, fig.margin=TRUE, fig.show='hold', fig.cap="Bar chart for Likert-scale questions", fig.align='center', out.width="100%", out.height="150%", echo=FALSE}
include_graphics("CT All.png")
```

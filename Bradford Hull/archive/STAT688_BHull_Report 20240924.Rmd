...
```{r, fig.margin=TRUE, fig.show='hold', fig.cap="ECDF Curve", fig.align='center', out.width="75%", echo=FALSE}
...
```{r, fig.margin=TRUE, fig.show='hold', fig.cap="Survival Curve", fig.align='center', out.width="75%", echo=FALSE}
...
```{r, fig.margin=TRUE, fig.show='hold', fig.cap="Survival Curve with medians", fig.align='center', out.width="75%", echo=FALSE}
include_graphics("survival_curve_medians.png")
```

```{r, fig.margin=TRUE, fig.show='hold', fig.cap="ECDF Curve with medians", fig.align='center', out.width="75%", echo=FALSE}
include_graphics("ECDF_curve_medians.png")
```

### **4. Recommended further study**

We recommend running a similar analysis as in replicate 1, and plot the survival curves and empirical CDF for replicates 2 and 3, as well as for experiments 2 and 3.
...
data <- read.csv("Liquid_experiment1.csv", header = TRUE)
